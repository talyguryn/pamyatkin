  ...
  sections: [
    {
      ...
      content: {
        value: '',
        placeholder: `Например, спрятать провода, закрыть окна, убрать цветы с пола, опасные и мелкие предметы. Это поможет питомцу не пораниться и не отравиться. Не пускайте питомца на диван и кровать, чтобы он не мог оттуда упасть.`,
      },
    },
    {
      title: {
      ...
      content: {
        value: '',
        placeholder:
          'Первым делом купите лежанку, пару игрушек, туалет или пеленки и выберите тихое место для отдыха. Это поможет питомцу адаптироваться к новому дому.',
      },
    },
    {
      title: {
